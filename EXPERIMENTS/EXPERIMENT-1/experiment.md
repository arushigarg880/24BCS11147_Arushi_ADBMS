...
Populate the hospital database tables with the provided records, then retrieve the first records from the Doctors, Patients, and Appointments tables.

## Question

Step 1:
Insert the data into the tables exactly as shown below (use the same table names, field names, and values).

Step 2:
After inserting the data, write SQL queries to fetch the first record from each of the first three tables: Doctors, Patients, and Appointments.
